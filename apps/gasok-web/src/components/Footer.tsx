    ...
    <footer className="site-footer">
      ...
      <div className="footer-main">
        <div className="footer-statement">
          ...
          <p>Programmable settlement infrastructure for machine commerce. It is extended with explicit authority, agreement, evidence, and resolution.</p>
        </div>
        <div className="footer-links">
          ...
          <div><span>BUILD</span><Link to="/build">Architecture</Link><Link to="/docs/agent-kernel">Agent Kernel</Link><Link to="/docs/railscard">RailsCard</Link><Link to="/docs/railsflow">RailsFlow</Link><Link to="/docs/security">Security</Link></div>
